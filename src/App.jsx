...
const CATEGORY_DATA = {
  'football-players': [
    ...
    { id: 3, name: 'كيليان مبابي', details: 'لاعب فرنسي، نجم باريس سان جيرمان.', image: 'https://placehold.co/400x300/4ECDC4/FFFFFF?text=مبابي' },
    { id: 4, name: 'إيرلينغ هالاند', details: 'مهاجم نرويجي، يلعب في مانشستر سيتي.', image: 'https://placehold.co/400x300/45B7D1/FFFFFF?text=هالاند' },
    { id: 5, name: 'كيفين دي بروين', details: 'لاعب وسط بلجيكي، نجم مانشستر سيتي.', image: 'https://placehold.co/400x300/96CEB4/FFFFFF?text=دي+بروين' },
    { id: 6, name: 'نيمار جونيور', details: 'لاعب برازيلي، يلعب في الهلال السعودي.', image: 'https://placehold.co/400x300/FFEAA7/000000?text=نيمار' },
    ...
    { id: 15, name: 'تياغو سيلفا', details: 'مدافع برازيلي، يلعب في تشيلسي.', image: 'https://placehold.co/400x300/00CEC9/FFFFFF?text=سيلفا' },
    ...
    { id: 20, name: 'جواو فيليكس', details: 'مهاجم برتغالي، يلعب في برشلونة.', image: 'https://placehold.co/400x300/A29BFE/FFFFFF?text=فيليكس' },
  ],
  'football-teams': [
